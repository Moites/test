...
class ModelDash:
    ...
    def create_dash(self):
        ...
        def update_dash(region, time_of_day):
            ...
            fig1 = px.bar(season_data, x='season', y='step_frequncy',
                          labels={'season': 'Сезон', 'step_frequncy': 'Среднее количество шагов'},
                          color='step_frequncy', title='Средняя частота шагов по сезонам')
            ...
            fig4 = px.scatter(filtered_df, x='elevation', y='step_frequncy',
